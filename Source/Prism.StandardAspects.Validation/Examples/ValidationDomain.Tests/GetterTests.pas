...
type
  ...
  public
    ...
    [aspect:Prism.StandardAspects.Validation.Aspects.DateTimeHasValue('SomeDateTime needs a value')]
    property SomeDateTime:DateTime read get_SomeDateTime write set_SomeDateTime;
    [aspect:Prism.StandardAspects.Validation.Aspects.DateTimeHasValue('SomeOtherDateTime needs a value')]
    property SomeOtherDateTime:DateTime;

    [aspect:Prism.StandardAspects.Validation.Aspects.Int32BetweenValues(5,10,'SomeValue is not in range')]
    ...
    [aspect:Prism.StandardAspects.Validation.Aspects.Int32BetweenValues(5,10,'SomeOtherValue is not in range')]
    [aspect:Prism.StandardAspects.Validation.Aspects.NumericHasValue('SomeOtherValue must be greater than zero')]
    ...
    [aspect:Prism.StandardAspects.Validation.Aspects.StringHasLength('',10)]
    [aspect:Prism.StandardAspects.Validation.Aspects.StringNullOrEmpty('SomeOtherStringValue must have a value')]
