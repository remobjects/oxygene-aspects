...
<Project xmlns="http://schemas.microsoft.com/developer/msbuild/2003" ToolsVersion="4.0" DefaultTargets="Build">
    ...
    <ItemGroup>
        ...
        <ProjectReference Include="..\..\RemObjects.Elements.StandardAspects.Validation.Silverlight\RemObjects.Elements.StandardAspects.Validation.Silverlight.oxygene">
            <Name>RemObjects.Elements.StandardAspects.Validation.Silverlight</Name>
            <Project>{21f00f20-31b7-4e87-a80a-864bcb5ec6f2}</Project>
            <Private>True</Private>
            <HintPath>..\..\RemObjects.Elements.StandardAspects.Validation.Silverlight\Bin\Debug\Validation.Silverlight.dll</HintPath>
        </ProjectReference>
    ...
    <ProjectExtensions>
        <VisualStudio>
            <FlavorProperties xmlns="" GUID="{A1591282-1198-4647-A2B1-27E5FF5F6F3B}">
