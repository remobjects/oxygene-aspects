...
type
  ...
  protected 
    method SomeMethod;
  public
    [aspect:Prism.StandardAspects.EnterpriseLibrary.Aspects.Logging(EnterpriseConstants.loggingCategory)]
    [aspect:Prism.StandardAspects.EnterpriseLibrary.Aspects.LoggingException(EnterpriseConstants.policyName)]
